<template>
  <div :class="$style.player">
    ...
    <div :class="$style.picContent" :aria-label="$t('player__pic_tip')" @contextmenu="handleToMusicLocation" @click="showPlayerDetail">
      ...
      <div :class="$style.nicon">
        <div :class="$style.container">
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="currentColor" d="M6.4 19H8q.425 0 .713.288T9 20t-.288.713T8 21H4q-.425 0-.712-.288T3 20v-4q0-.425.288-.712T4 15t.713.288T5 16v1.6l2.4-2.4q.275-.275.7-.275t.7.275t.275.7t-.275.7zM19 6.4l-2.4 2.4q-.275.275-.7.275t-.7-.275t-.275-.7t.275-.7L17.6 5H16q-.425 0-.712-.288T15 4t.288-.712T16 3h4q.425 0 .713.288T21 4v4q0 .425-.288.713T20 9t-.712-.288T19 8z"></path></svg>
        </div>
      </div>
    </div>
    ...
    <div :class="$style.playBtnContent">
      ...
      <div :class="$style.playBtn" :aria-label="isPlay ? $t('player__pause') : $t('player__play')" @click="togglePlay">
        <svg v-if="isPlay" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="42" height="42">
        ...
        <svg v-else viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="42" height="42">
...
.picContent {
  ...
  .nicon{
    ...
    cursor: pointer;
    opacity: 0; /* 初始状态为隐藏 */
    transform: scale(0.4); /* 初始缩放 */
    transition: transform 0.1s ease, opacity 0.1s ease; /* 平滑过渡效果 */
  }
  .container{
    display: flex;
    align-items: center;
